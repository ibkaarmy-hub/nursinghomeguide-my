...
const GROUPS = {
  ...
  'merry-care-centre': {
    ...
    name: 'Merry Care',
    tagline: 'Seven-branch affordable nursing home chain across Kepong, Selayang & Desa Jaya',
    website: 'https://www.elderlycare.my/',
    state: 'Kuala Lumpur, Selangor',
    description: 'Merry Care operates seven nursing home branches across the Klang Valley — the Kuchai Lama HQ, four clustered in Kepong Baru, one in Taman Desa Jaya, and one in Selayang Baru. The chain markets at elderlycare.my and positions on the affordable end of the residential care market, with a published starting rate of RM 2,500/month for shared rooms including five meals a day.',
    branches: [
      'merry-care-centre',
  ...
  'care-concierge': {
    slug: 'care-concierge',
    name: 'Care Concierge',
    tagline: 'Multi-branch premium eldercare across Selangor, KL, Penang & Sarawak',
    website: 'https://mycareconcierge.com',
    state: 'Selangor, Kuala Lumpur, Penang, Sarawak',
    description: 'Care Concierge runs a network of "Mansion" premium care residences plus the Care Luxe brand. Locations confirmed on mycareconcierge.com include The Mansion Gasing 58/136, Sri Aman, Ara Woods, Ampang, plus Care Luxe (KL), Angsana Home and Tanjung Point Residences (Penang). A Pantai branch and a Sarawak Care Collective are listed as opening in 2026.',
    branches: [
      'care-concierge-malaysia',
      'care-concierge-care-luxe-ampang',
      'ara-woods-senior-care-centre',
    ],
  },
  'seavoy-nursing-home': {
    slug: 'seavoy-nursing-home',
    name: 'Seavoy Nursing Home',
    tagline: 'Two KL-area branches in Desa Melawati and Taman Setapak Indah',
    website: 'http://www.seavoynursinghome.com',
    state: 'Kuala Lumpur, Selangor',
    description: 'Seavoy Nursing Home operates two residential care branches in the Desa Melawati / Setapak Indah corridor of north-east KL.',
    branches: [
      'seavoy-nursing-home-desa-melawati',
      'seavoy-nursing-home-taman-setapak-indah',
    ],
  },
  'alexa-villa': {
    slug: 'alexa-villa',
    name: 'Alexa Villa Senior Care Centre',
    tagline: 'Two single-gender branches in the Sendayan / Seremban district',
    website: 'https://alexahealthcare.com',
    state: 'Negeri Sembilan',
    description: 'Alexa Villa is the eldercare arm of Alexa Healthcare. Per the operator site, the network includes a Tiara Sendayan (female) branch in Labu and a Suriaman Sendayan (male) branch in Seremban, plus an affiliated medical clinic in Nilai.',
    branches: [
      'alexa-villa-senior-care-centre',
      'alexa-villa-senior-care-centre-caw',
    ],
  },
  'elderlove': {
    slug: 'elderlove',
    name: 'Elderlove',
    tagline: 'Five-branch eldercare chain across the Klang Valley, Ipoh and KL',
    website: 'https://elderlovemissi.com.my',
    state: 'Selangor, Perak, Kuala Lumpur',
    description: 'Elderlove operates five branches per its own site: Sungai Long (Kajang), Puchong Skypod Square, Sg Buloh / Kota Damansara / Pinggiran Subang, Bercham (Ipoh), and SKGV Pudu (KL).',
    branches: [
      'elderlove-care-centre',
      'elderlove-living-care-centre',
      'elderlove-living-care-centre-puchong',
      'elderlove-living-care-centre-sglong',
    ],
  },
  'keepers': {
    slug: 'keepers',
    name: 'Keepers Nursing & Caregiving',
    tagline: 'Penang multi-branch nursing and dementia care',
    website: 'https://myknc.com.my',
    state: 'Penang',
    description: 'Keepers (myknc.com.my) operates three Penang care branches — Wellesley Assisted Living & Rehabilitation (Seberang Perai), Concordia Dementia Care (Georgetown), and a Specialised Care Centre (Tanjung Tokong) — plus a private nursing service to home.',
    branches: [
      'keepers-dementia-care-centre-sdn-bhd',
      'keepers-medi-care-centre-sdn-bhd',
    ],
  },
  'my-precious-home-care': {
    slug: 'my-precious-home-care',
    name: 'My Precious Home Care',
    tagline: 'Two branches in Subang Jaya (Elder Care) and Petaling Jaya (Retirement Home)',
    website: 'https://myprecioushomecare.com',
    state: 'Selangor',
    description: 'My Precious Home Care operates two residential branches in the Klang Valley — an Elder Care site in Grandville, Subang Jaya (4.7★) and a Retirement Home site in Kampung Tunku, Petaling Jaya (5.0★).',
    branches: [
  ...
  'rumah-victory': {
    slug: 'rumah-victory',
    name: 'Rumah Victory',
    tagline: 'Welfare-association eldercare with two related care centres',
    website: 'https://rumahvictory.org.my',
    state: 'Selangor, Negeri Sembilan',
    description: 'Rumah Victory is a welfare organisation operating multiple service centres including an elderly home in Puchong (HQ at Bukit Kuchai) and the True House of Victory Care Centre in Seremban, Negeri Sembilan. Google attributes both rows to the rumahvictory.org.my domain.',
    branches: [
      'rumah-victory-elderly-home',
      'true-house-of-victory-care-centre',
    ],
  },
};
