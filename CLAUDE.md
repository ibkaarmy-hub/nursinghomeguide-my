...
## SEO infrastructure (locked 2026-05-03)

- Canonical host: `https://nursinghomeguide.my` (custom domain via Namecheap → GitHub Pages, CNAME committed)
- Per-facility static pages at `/facility/<slug>/index.html` with baked-in OG / Twitter / canonical / LocalBusiness JSON-LD — required because crawlers (WhatsApp, FB, Google) don't run JS. Generated by `generate_facility_pages.py`.
- Legacy `facility.html?slug=X` URLs redirect to the new clean URL form.
